...
API_ID = int(environ.get('API_ID', '21769773'))
API_HASH = environ.get('API_HASH', '7c110385c0040e41fcaa2ccdf50f7072')
BOT_TOKEN = environ.get('BOT_TOKEN', "7976120705:AAEq8nSAXjS-mPK7tf8Qa12pb3aB6pCfW-M")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7206348966').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002524549144'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002413326353').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Hinn:Hinn@cluster0.x5qox57.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "flix_senderbot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'hinncollection')
